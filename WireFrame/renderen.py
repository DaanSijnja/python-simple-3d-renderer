...
def matrix_point_vgm(p,m):
    ...
    new_point[3] = round(p[0]*m[3][0] + p[1]*m[3][1] + p[2]*m[3][2] + new_point[3]*m[3][3],4)
    return new_point[:3]
...
charcarters = {
    'a': [ [ [-5,5], [-5,25], [-15,25], [-15,-15], [-5,-25], [5,-25], [15,-15], [15,25], [5,25], [5,5] ] , [ [-5,-5], [-5,-15], [5,-15], [5,-5] ], [15,25] ],
    'b': [ [ [-15,25], [-15,-25], [5,-25], [15,-15], [15,-5], [10,0], [15,5], [15,15], [5,25] ] ,[ [5,5],[5,15],[-5,15],[-5,5] ],[ [5,-5],[5,-15],[-5,-15],[-5,-5] ], [15,25] ],
    'c': [ [ [-5,25], [-15,15], [-15,-15], [-5,-25], [5,-25], [15,-15], [15,-5], [5,-5], [5,-15], [-5,-15], [-5,15], [5,15], [5,5], [15,5], [15,15], [5,25] ], [15,25] ],
    'd': [ [ [-15,25], [-15,-25], [5,-25], [15,-15], [15,15], [5,25] ], [ [-5,15], [-5,-15], [5,-15], [5,15] ], [15,25] ],
    'e': [ [ [-15,25], [-15,-25], [15,-25], [15,-15], [-5,-15], [-5,-5], [15,-5], [15,5], [-5,5], [-5,15], [15,15], [15,25] ], [15,25] ],
    'f': [ [ [-15,25], [-15,-25], [15,-25], [15,-15], [-5,-15], [-5,-5], [15,-5], [15,5], [-5,5], [-5,25] ], [15,25] ],
    'g': [ [ [-10,25], [-20,15], [-20,-15], [-10,-25], [10,-25], [20,-15], [-10,-15], [-10,15], [10,15], [10,5], [0,5], [0,-5], [20,-5], [20,15], [10,25] ], [15,25] ],
    'h': [ [ [-15,25], [-15,-25], [-5,-25], [-5,-5], [5,-5], [5,-25], [15,-25], [15,25], [5,25], [5,5], [-5,5], [-5,25] ], [15,25] ],
    'i': [ [ [-15,25], [-15,15], [-5,15], [-5,-15], [-15,-15], [-15,-25], [15,-25], [15,-15], [5,-15], [5,15], [15,15], [15,25] ], [15,25] ], 
    'j': [ [ [-15,15], [-15,5], [-5,5], [-5,15], [5,15], [5,-15], [-5,-15], [-5,-25], [15,-25], [15,15], [5,25], [-5,25] ], [15,25] ],
    'k': [ [ [-15,25], [-15,-25], [-5,-25], [-5,-5], [5,-15], [5,-25], [15,-25], [15,-10], [5,-0], [5,0], [15,10], [15,25], [5,25], [5,15], [-5,5], [-5,25] ], [15,25] ], 
    'l': [ [ [-15,25], [-15,-25], [-5,-25], [-5,15], [15,15], [15,25] ], [15,25] ],
    'm': [ [ [-20,25], [-20,-25], [-10,-25], [0,-15], [10,-25], [20,-25], [20,25], [10,25], [10,-10], [0,0], [-10,-10], [-10,25] ], [20,25] ],
    'n': [ [ [-15,25], [-15,-25], [-5,-25], [5,0], [5,-25], [15,-25], [15,25], [5,25], [-5,0], [-5,25] ], [15,25] ],
    'o': [ [ [-5,25], [-15,15], [-15,-15], [-5,-25], [5,-25], [15,-15], [15,15], [5,25] ], [ [-5,15], [-5,-15], [5,-15], [5,15] ], [15,25] ],
    'p': [ [ [-15,25], [-15,-25], [5,-25], [15,-15], [15,-5], [5,5], [-5,5], [-5,25] ], [ [-5,-5], [-5,-15], [5,-15], [5,-5] ], [15,25] ],
    'q': [ [ [15,25], [15,-25], [-5,-25], [-15,-15], [-15,-5], [-5,5], [5,5], [5,25] ], [ [-5,-5], [-5,-15], [5,-15], [5,-5] ], [15,25] ],
    'r': [ [ [-15,25], [-15,-25], [5,-25], [15,-15], [15,-5], [10,0], [15,5], [15,25], [5,25], [5,5], [-5,5], [-5,25] ], [ [-5,-5], [-5,-15], [5,-15], [5,-5] ], [15,25] ],
    's': [ [ [-15,25], [-15,15], [5,15], [5,5], [-5,5], [-15,-5], [-15,-15], [-5,-25], [15,-25], [15,-15], [-5,-15], [-5,-5], [5,-5], [15,5], [15,15], [5,25] ], [15,25] ],
    't': [ [ [-5,25], [-5,-15], [-15,-15], [-15,-25], [15,-25], [15,-15], [5,-15], [5,25] ], [15,25] ],
    'u': [ [ [-5,25], [-15,15], [-15,-25], [-5,-25], [-5,15], [5,15], [5,-25], [15,-25], [15,25] ], [15,25] ],
    'v': [ [ [-5,25], [-15,15], [-15,-25], [-5,-25], [-5,10], [0,15], [5,10], [5,-25], [15,-25], [15,15], [5,25] ], [15,25] ],
    'w': [ [ [-10,25], [-20,15], [-20,-25], [-10,-25], [-10,10], [0,0], [10,10], [10,-25], [20,-25], [20,15], [10,25], [0,15] ], [20,25] ],
    'x': [ [ [-15,25], [-15,5], [-10,0], [-15,-5], [-15,-25], [-5,-25], [-5,-10], [0,-5], [5,-10], [5,-25], [15,-25], [15,-5], [10,0], [15,5], [15,25], [5,25], [5,10], [0,5], [-5,10], [-5,25] ], [15,25] ],
    'y': [ [ [-5,25], [-5,5], [-15,-5], [-15,-25], [-5,-25], [-5,-10], [0,-5], [5,-10], [5,-25], [15,-25], [15,-5], [5,5], [5,25] ], [15,25] ],
    'z': [ [ [-15,25], [-15,15], [5,15], [-15,-15], [-15,-25], [15,-25], [15,-15], [-5,-15], [15,15], [15,25] ], [15,25] ],
    ' ': [ [ ], [15,25] ]
}

def generate_symbol(char,color,is3D = False,thickness = 10):
    coords = charcarters[char.lower()]
    ...
    for figs in coords:
        l_figs = len(figs)
        for i in range(l_figs):
            p1 = [*figs[i],z]
            p2 = [*figs[(i + 1) % l_figs],z]
            fig.append(Line(p1,p2,color))
            if(is3D == True):
                p1 = [*figs[i],z]
                p2 = [*figs[i],-z]
                fig.append(Line(p1,p2,color))
...
def generate_string(string,spacing=0,is3D=False):
    fig = []
    string_lenght = len(string)

    def calulate_offset(string,spacing):
        string_lenght = len(string)
        offset = []
        _set = 0
        for i in range(string_lenght):
            if(i == 0):
                ...
                size_v = charcarters[string[i-1].lower()][-1][0]
                size_s = charcarters[string[i].lower()][-1][0]
                _set += (size_s+size_v)+spacing
                offset.append(_set)
            
        return offset, _set/2

    offset, mid= calulate_offset(string,spacing)
    for i in range(string_lenght):
        let = generate_symbol(string[i],(255,255,255),is3D)
        let = translate_fig(let,create_transform_matrix(offset[i],0,0))
        for item in let:
            fig.append(item)

    fig = translate_fig(fig,create_transform_matrix(-mid,0,0))
...
'''Alle letters demo setup '''
letters = [key for key in charcarters]
_letters_rotated = 0
_letters_color_m = 0
letter = []
'''Alle letters Demo'''
def demo_letters(canvas,a = 180//2.6):
    global _letters_rotated
    global _letters_color_m
    global letters
    global letter

    werkvlak = canvas.copy()
    if(_letters_rotated % a == 0 or _letters_rotated == 0):
        next_letter = letters[_letters_color_m%len(letters)]

        r = _letters_color_m % 3

        g = _letters_color_m % 9 

        b = _letters_color_m % 26
        if(_letters_rotated == 0):
            r, g, b = 3, 9, 26
        letter = generate_symbol(next_letter,(int(b*255/26),int(g*255/9),int(r*255/3)),True)

        letter = translate_fig(letter,create_scale_matrix(3,3,3))
        _letters_color_m += 1

    letter = translate_fig(letter,create_rot_matrix((3,3,3)))
    _letters_rotated += 1
    
    pers_letter = perspective_fig(letter,plane,camera)

    werkvlak = draw_fig(werkvlak,[pers_letter],thickness=2,calulate_order=False)
...
fig = generate_cube(50,(255,255,0))
while True:
    werkvlak = canvas.copy() 
